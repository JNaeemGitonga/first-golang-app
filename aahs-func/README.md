...
This is a sample template for aahs-func - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name aahs-func --query 'Stacks[].Outputs'
```
